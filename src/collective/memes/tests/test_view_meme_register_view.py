...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_meme_register_view_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='meme-register-view'
        )
        self.assertTrue(view.__name__ == 'meme-register-view')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in meme-register-view'
        # )

    def test_meme_register_view_not_matching_interface(self):
